...
!function ($) {
    ...
    MorrisCharts.prototype.createLineChart = function (element, data, xkey, ykeys, labels, lineColors) {
        ...
        MorrisCharts.prototype.init = function () {
            ...
            this.createLineChart('morris-line-example', $data, 'y', ['a', 'b', 'c'], ['Activated', 'Pending', 'Deactivated'], ['#ccc', '#ffa726', '#4bbbce']);
            ...
            this.createStackedChart('morris-bar-stacked', $stckedData, 'y', ['a', 'b'], ['Series A', 'Series B'], ['#ffa726', '#f0f1f4']);
