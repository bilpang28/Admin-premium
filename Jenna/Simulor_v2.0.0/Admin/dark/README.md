...
# Simulor - The most complete web ui kit and dashboard template

Thank you for purchasing Simulor :). The following guideline will help you to get started with ubold and its documentation.
